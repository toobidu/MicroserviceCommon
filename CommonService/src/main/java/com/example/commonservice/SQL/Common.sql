...
CREATE OR REPLACE TRIGGER DEPARTMENT_TRG
    ...
    FOR EACH ROW
BEGIN
    SELECT DEPARTMENT_SEQ_ID.NEXTVAL
    INTO :NEW.DEPARTMENT_ID
    FROM DUAL;
END;
/

SELECT SEQUENCE_NAME FROM USER_SEQUENCES WHERE SEQUENCE_NAME = 'DEPARTMENT_SEQ';
ALTER TABLE DEPARTMENT ADD VERSION NUMBER(10) DEFAULT 0;